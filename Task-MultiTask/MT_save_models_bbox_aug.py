...
Seg_model_name = "/home/caap/LabelReliability_and_PathologyDetection_in_ChestXrays/Models/Unet_allds_200epochs.hdf5"
Seg_model = load_our_model(Seg_model_name)
...
for gamma in gamma_list:
    ...
    model_acc1 = PD_save_models(json_name=path+f"MT_model1_gamma_{gamma}.json", h5_name=path+f"MT_model1_gamma_{gamma}.h5", gamma=gamma,lr=learning_rate_list[0])
