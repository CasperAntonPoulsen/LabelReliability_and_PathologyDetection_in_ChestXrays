...
for lr in learning_rate_list:
    ...
    model_acc2 = PD_save_models(json_name=path+"PD_model2.json", h5_name=path+"PD_model2.h5", lr=lr)
    model_acc3 = PD_save_models(json_name=path+"PD_model3.json", h5_name=path+"PD_model3.h5", lr=lr)
